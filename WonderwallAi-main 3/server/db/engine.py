...
async def _migrate_add_missing_columns() -> None:
    ...
    migrations = [
        ...
        # UsageRecord observability (added for intent logging)
        ("usage_records", "request_id", "VARCHAR(16)"),
        ("usage_records", "scores", "TEXT"),       # JSON stored as TEXT in SQLite
        ("usage_records", "violations", "TEXT"),   # JSON stored as TEXT in SQLite
    ]
